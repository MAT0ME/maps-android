<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LectureClassList.aspx.cs" Inherits="Web_Application_Dot_Net.LectureClassList" %>
...
<body style="background-image: url(../Pic/macro.jpg); background-repeat:no-repeat; background-attachment:fixed"><div align ="center">
    <form id="form1" runat="server">
        
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="299px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="414px" DataSourceID="SqlDataSource1">
