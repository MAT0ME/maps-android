    ...
    public partial class LectureClassTest : System.Web.UI.Page
    {
        ...
        void Saving_to_database()
        {
            ...
            if (Temp == 1)
            {
                ...
                SqlCommand cmd = new SqlCommand($"INSERT INTO {DataTableTB.QuestionsTable}({QuestionsTable.ColumnQuestions},{QuestionsTable.ColumnOption1},{QuestionsTable.ColumnOption2},{QuestionsTable.ColumnAnswer})" +
...
//                scm = new SqlCommand("UPDATE questions SET question=@qs, question_o1=@qo1, question_o2=@qo2, question_o3=@qo3,correct_answer=@ca  WHERE q_num=@qn", sc);
                ...
                SqlCommand cmd = new SqlCommand($"Update {DataTableTB.QuestionsTable} SET {QuestionsTable.ColumnQuestions} =@Q,{QuestionsTable.ColumnOption1} =@Q1,{QuestionsTable.ColumnOption2} =@q2,{QuestionsTable.ColumnAnswer} =@CA Where Question_Number=@QN" , connection);
        ...
        void Testing() {
            ...
            SqlCommand command = new SqlCommand($"SELECT * FROM {DataTableTB.QuestionsTable}", connection);
