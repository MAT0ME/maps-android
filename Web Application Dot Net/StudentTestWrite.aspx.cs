    ...
    public partial class StudentTestWrite : System.Web.UI.Page
    {
        ...
        void LoadTest()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand($"SELECT * FROM {DataTableTB.QuestionsTable}", connection);
        ...
        void Save_info_database()
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand($"INSERT INTO {DataTableTB.StudentMarksTable} ({StudentMarksTable.ColumnName},{StudentMarksTable.ColumnSurname},{StudentMarksTable.ColumnMark},{StudentMarksTable.ColumnPecentage}) values(@N, @S, @M, @P)", connection);
            ...
            {
                MessageBox.Show(this, "Error couldn't save to database");
            }
